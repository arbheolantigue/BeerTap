...
using IqmetrixBeerTap.Documentation.Installers;
using IqmetrixBeerTap.Domain.Controller;
using IqmetrixBeerTap.WebApi.Handlers;
using IqmetrixBeerTap.WebApi.Hypermedia;
using IqmetrixBeerTap.WebApi.Infrastructure.Installers;
using IqmetrixBeerTap.Model;
using IQ.Platform.Framework.WebApi.Infrastructure;

namespace IqmetrixBeerTap.WebApi.Infrastructure
{
    ...
    public class DefaultApiContainer : ApiContainer
    {
        ...
        readonly Assembly _domainRepositoriesAssembly = typeof(IRepositoryService<>).Assembly;
        //
                ...
                .Install(new IWindsorInstaller[]
                         {
                             ...
                             new DomainRepositories(_domainRepositoriesAssembly), 
        ...
        {
            return
                _windsorContainer.Resolve<ApiSecurityContextProvidingHandler<IqmetrixBeerTapApiUser, NullUserContext>>();
        }
